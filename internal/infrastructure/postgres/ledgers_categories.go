...
func (r *LedgerRepository) CreateCategory(ctx context.Context, ledgerID v1.ID, category *v1.Category) error {
...
func (r *LedgerRepository) GetCategories(ctx context.Context, ledgerID v1.ID) ([]v1.Category, error) {
