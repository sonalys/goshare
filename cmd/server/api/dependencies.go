...
type (
	...
	LedgerController interface {
		...
		FindExpense(ctx context.Context, ledgerID, expenseID v1.ID) (*v1.Expense, error)
		GetExpenses(ctx context.Context, params ledgers.GetExpensesRequest) (*ledgers.GetExpensesResult, error)
	}
